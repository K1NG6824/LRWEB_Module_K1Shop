				...
				$this->hardReturnJson($result);
					...
					switch ($method){
			            ...
			            case 'pay':
			                ...
			                $this->LkAddLog('_NewDonat', ['gateway'=>'UnitPay','order'=>$this->decod[1], 'course'=>$this->Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_AmountCourse'), 'amount' => $this->decod[2], 'steam'=>$this->decod[3]]);
			                $admins = $this->db->queryAll( 'Core', 0, 0, "SELECT * FROM lvl_web_admins WHERE flags = 'z' ");
							 ...
							 $this->Notifications->SendNotification( 
								 	$this->decod[3], 
								 	'_YouPay', 
								 	['course'=>$this->Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_AmountCourse'),'amount'=> $params['orderSum'],'module_translation'=>'module_page_shop_impulse_k1ng'],
								 	'lk/?section=payments#p'.$this->decod[1], 
								 	'money'
							);
