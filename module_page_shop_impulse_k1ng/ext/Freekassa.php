...
class Freekassa extends Basefunction{
	...
	public function FKProcessPay($post){
		$BCheckPay = $this->BCheckPay('FreeKassa');
		 ...
		 $this->LkAddLog('_NewDonat', ['gateway'=>'FreeKassa','order'=>$this->decod[1], 'course'=>$this->Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_AmountCourse'), 'amount' => $this->decod[2], 'steam'=>$this->decod[3]]);
