...
use app\modules\module_page_shop_impulse_k1ng\ext\Lk_module;
...
if(!empty($_GET['gateway'])){
    require MODULES.'module_page_shop_impulse_k1ng/includes/result.php';
    exit;
}

if(empty($Db->db_data['lk']))
{
    require MODULES.'module_page_shop_impulse_k1ng/includes/install.php';
    exit;
}
...
$Modules->set_page_title( $General->arr_general['short_name'] . ' :: ' . $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LK'));

// Задаём описание страницы.
$Modules->set_page_description( $General->arr_general['short_name'] . ' :: ' . $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LK') . ' :: ' . $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_DescPageLK'));
