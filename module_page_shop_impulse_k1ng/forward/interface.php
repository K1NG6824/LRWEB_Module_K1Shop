        ...
        <div class="card menu">
            <ul class="nav">
                <li <?php get_section( 'section', 'gateways' ) == 'users' && print 'class="table-active"'?> onclick="location.href = '<?php echo set_url_section(get_url( 2 ),'section','users')?>';">
                    <a><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_UsersList')?></a>
                </li>
                <li <?php get_section( 'section', 'gateways' ) == 'gateways' && print 'class="table-active"'?> onclick="location.href = '<?php echo set_url_section(get_url( 2 ),'section','gateways')?>';">
                    <a><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_SettingsGateways')?></a>
                </li>
                <li <?php get_section( 'section', 'gateways' ) == 'payments' && print 'class="table-active"'?> onclick="location.href = '<?php echo set_url_section(get_url( 2 ),'section','payments')?>';">
                    <a><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_PaymentsList')?></a>
                </li>
                <li <?php get_section( 'section', 'gateways' ) == 'promocodes' && print 'class="table-active"'?> onclick="location.href = '<?php echo set_url_section(get_url( 2 ),'section','promocodes')?>';">
                    <a><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Promo')?></a>
                </li>
                <li <?php get_section( 'section', 'gateways' ) == 'logs' && print 'class="table-active"'?> onclick="location.href = '<?php echo set_url_section(get_url( 2 ),'section','logs')?>';">
                    <a><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Logs')?></a>
                </li>
            </ul>
        </div>
    </section>
...
if(!empty($_GET['section']) && isset($_SESSION['steamid32'])):?>
    <div class="row">
        <?php switch ( $_GET['section']):
            case $_GET['section']:
                require MODULES . 'module_page_shop_impulse_k1ng/includes/'.$_GET['section'].'.php';
                break;
        endswitch;?>
</div>
<?php else:?>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="badge"><i class="zmdi zmdi-money zmdi-hc-fw"></i> <?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LK')?></h5>
                <div style="position: absolute;top: 15px;right: 15px;text-align: center;" id="profile"></div>
                    ...
                    <div class="col-10 col-md-8 align-center">
                        ...
                        <?php if(!empty($Gateways)):
                                ...
                                <div class="input-form text-center"><div style="margin-bottom: 10px;" class="input_text text-left"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_ChangeGateway')?></div>
                                <?php foreach($Gateways as $info):?>
                                    ...
                                    <label for="Gateway<?=$info['id']?>" style="background: url('<?php echo $General->arr_general['site'] . MODULES ?>module_page_shop_impulse_k1ng/assets/gateways/<?php echo mb_strtolower($info['name_kassa'])?>.svg') no-repeat;background-position: center;" class="gateways-label"></label>
                                    ...
                                    <label for="Gateway99" style="background: url('<?php echo $General->arr_general['site'] . MODULES ?>module_page_shop_impulse_k1ng/assets/gateways/yandexmoneycard.svg') no-repeat;background-position: center;" class="gateways-label"></label>
                        ...
                        <div class="input-form">
                            <div class="input_text"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_ToUpAmount')?></div>
                            <input name="amount">
                        </div>
                        <div class="input-form">
                            <div class="input_text"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Promo')?></div>
                    ...
                    <div class="card-bottom text-center padding-botom-20">
                        <input class="btn" form="pay" type="submit" value="<?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_ButtonPay')?>"></h5>
                    </div>
                    <br>
