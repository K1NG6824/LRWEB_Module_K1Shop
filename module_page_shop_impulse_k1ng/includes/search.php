...
<div class="col-md-7">
        <div class="card">
            <div class="card-header">
                <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_SearchStatus')?></h5>
            </div>
            <div class="card-container">
            <?php if(empty($_SESSION['search'])):?>
            	<?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Noresult')?>
            <?php else:?>
                <table class="table table-hover">
                    ...
                    <?php foreach ($_SESSION['search'] as $key):
                        ...
                        <tr>
                            ...
                            <th class="text-left"><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_AmountCourse' )?> <?php echo $key[$cash] ?></th>
                            <th class="text-left"><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_AmountCourse' )?> <?php echo $key[$all_cash] ?></th>
                ...
                <?php if(sizeof($_SESSION['search']) >6): $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_maxResult'); endif?>
            <?php endif;?>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-container">
               ...
               <button class="btn" type="submit" form="search_users" ><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_Search' )?></button>
            </div>
        </div>
    </div>
...
<div class="col-md-7">
    <div class="card">
        <div class="card-header">
            <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Information')?> - <?php echo $user[0]['name']?></h5>
            ...
            <div class="user_pays">
                <?php if(!empty($pays)):?>
                    ...
                    <tr>
                        ...
                        <th class="text-left"><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_Amount' )?></th>
                        <th class="text-left"><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_Promo' )?></th>
                        <th class="text-left"><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_Status' )?></th>
                    </tr>
                    </thead>
                    <tbody>
                            <?php foreach ($pays as $key):?>
                             <tr>
                                ...
                                <th class="text-left"><img src="<?php echo $General->arr_general['site'] ?>app/modules/module_page_shop_impulse_k1ng/assets/gateways/<?php echo mb_strtolower($key['pay_system'])?>.svg"></th>
                        ...
                        <?php else:?>
                    	<?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_NotPays' )?>
                <?php endif;?>
            </div>
        </div>
    </div>
