    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-header">
                <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_UsersList')?></h5>
        ...
        <div class="card">
            ...
            <div class="card-container">
                 <div class="select-panel">
                    ...
                    <button class="btn float-left" type="submit" form="users_clean" ><?php echo $Translate->get_translate_module_phrase( 'module_page_shop_impulse_k1ng', '_ClearZero' )?></button>
                </div>
