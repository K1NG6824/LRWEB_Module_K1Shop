...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LKInstall')?></h5>
                </div>
                <?php if(!empty($table)):?>
                    <div class="card-container option_one">
                        <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_InstallTable')?> <?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LK')?></h5><br>
                        <?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_ForWork')?><br>
                        <?php foreach($table as $tableKey => $val):?>
                            <b>`<?php echo $tableKey?>`</b><br>
                        <?php endforeach;?>
                        <form enctype="multipart/form-data" method="post">
                            <input class="btn" name="table_install" type="submit" value="<?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_InstallBTN')?>">
                        </form>
                    </div>
               <?php else :?>
                <div class="card-container option_one">
                    <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_SettingsBD')?></h5><br>
                    <?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LKForInstall')?> <a href="https://hlmod.ru/resources/lichnyj-kabinet-1mpulse-core-modules.887/"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LK')?></a>/<a href="http://projecttm.ru/product?id=11"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_K1-Shop')?></a>
                    ...
                    <div class="input-form"><div class="input_text">Host: </div><input name="host" value="<?php echo $_POST['host']?>"></div>
                        ...
                        <div class="input-form"><div class="input_text">Table: </div><input placeholder="<?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Example')?>: lk" name="table" value="<?php echo $_POST['table']?>"></div>
                        <div class="input-form"><div class="input_text">LK mod</div>
                            <select name="lk_mod">
                                <option value="1" <?php echo ($_POST['lk_mod'] == 1? "selected" : "");?> >LK Impulse</option>
                                <option value="2" <?php echo ($_POST['lk_mod'] == 2? "selected" : "");?>>LK McD4CK</option>
								<option value="3" <?php echo ($_POST['lk_mod'] == 3? "selected" : "");?>>K1-Shop</option>
                            </select>
                        </div>
                    </form>
                    <?php if ( $db_check != 2 ):?>
                    <input class="btn" name="db_check" type="submit" form="db_check" value="<?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_DBCheckBTN')?>">
                    <?php elseif( $db_check == 2 ):?>
                        <input class="btn" name="save_db" type="submit" form="db_check" value="<?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_NextBTN')?>">
                    <?php endif;?>
                </div>
        <?php endif;?>
            </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-header">
                    <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Information')?></h5>
                ...
                <div class="card-container">
                    <?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_Php')?> <?php if( PHP_VERSION >= '7' ) { echo '<div class="color-green">'  . PHP_VERSION . '</div>';} else { echo '<div class="color-red">'  . PHP_VERSION . '</div>
                    <div>'.$Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_PhpRecomendation').'</div>';} ?>
                    <div>cURL:</div>
                    <?php if (in_array ('curl', get_loaded_extensions())):?>
                     ...
                     <?php endif; ?>
                    <?php if ( $db_check == 1 ):?>
                        <div><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_DBCheckConnect')?></div>
                    <?php elseif( $db_check == 2 ): ?>
                        <div><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_DBCheckConnectSucc')?></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
