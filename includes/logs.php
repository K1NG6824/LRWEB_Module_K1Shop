...
<div class="col-md-2">
	<div class="card">
		<div class="card-header">
        	<h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng','_LogList');?></h5>
	...
	<div class="card">
    	...
    	<div class="card-container">
    		...
    		<?php foreach ($LK->LkLogContent($_GET['log']) as $key):?>
    			<?php echo $key['log_name'].$key['log_time'].LangValReplace($Translate->get_translate_module_phrase('module_page_shop_impulse_k1ng',$key['log_content']), json_decode(str_replace('[]','',$key['log_value']), true));?><br>
    		<?php endforeach;?>
    		</div>
    	</div>
